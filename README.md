...
---
### 工作經歷（ 共 5 年 ）
## 專案經理＋產品經理 — [禾多移動多媒體股份有限公司](https://www.avividai.com/)（2024.2～仍在職）
    
  ```
    
  （AviviD.ai）是一家結合行銷科技（MarTech）與廣告科技（AdTech）的公司，致力於運用數據分析與技術整合，為數位媒體、廣告、電商和媒體服務等領域提供創新的行銷解決方案，
   協助品牌提升廣告效益、優化轉換率，並拓展零售媒體聯播網的市場影響力。
   我加入公司時 LCDP、LRMN 已完成 70 ％ 的功能規劃，並準備上線 V1.0 版本，因此確保功能如實運作、如期上線為首要任務，並接續推動新功能的開發與舊功能的優化與迭代。
    
  ```
  - LCDP、LRMN
    - 舊功能維運：負責系統現有功能的日常維護，確保系統穩定運行，快速應變解決技術問題，保障客戶業務不中斷
    - 既有功能優化：蒐集使用單位（包含客戶與業務）的操作反饋與應用場景與開發團隊協作，制定迭代計畫，並制定開發資源投入的優先順序，執行功能改版與升級
    - 新功能規劃與開發安排：系統性蒐集使用單位（包含客戶與業務）的操作反饋與使用情境，分析需求痛點與改善空間
    - 顧客技術串接與導入服務：定義系統串接標準並提供技術指導，確保產品如期上線並於客戶業務中有效運行
    - 客戶需求管理：系統性蒐集使用單位反饋並分級排序，引導產品設計單位將相似或連動的功能整併思考，確保每次版更欲強化的功能與使用情境明確
    - 產品教育訓練：提供教育訓練單位操作教學，並依系統版本與安排操作手冊更新
  - 產品整合規劃與執行
    - 系統架構整併：主導多產品的功能與資料庫整合，成功將「來客」、「數位店長」等多個站內 MarTech 後台功能合併至 LCDP 平台，優化系統架構並提升產品一致性
    - 視覺與使用者體驗優化：推動介面設計統一，導入全新的 Design Guideline，提升操作流暢度與整體視覺效果，確保良好的用戶體驗
    - 擬定分階段整併策略：以階段性策略執行整併，第一階段｜完成功能頁籤搬移與資料庫對接；第二階段｜整合相似功能至單一頁籤；第三階段｜開發新功能並進一步優化用戶體驗
    - 效率提升與維護成本降低：透過相同報表與資料庫的整合，確保數據計算邏輯一致，提升報表運算效能，同時大幅降低維運成本
    - 跨部門協作：協調技術、設計與業務團隊，在產品整合過渡期提供雙後台支持，確保客戶無痛轉換至新平台
  - 策略合作與產品整合銷售 POC（合作夥伴｜輿情分析 ＋ AviviD｜品牌大聲公）
    - 全面剖析兩套產品的數據基礎，揭示兩者在指標構成（如正負向聲量、PV數）上的計算差異，建立能相互匹配的數據整合框架，補強數據 insight 的邏輯完整性，為後續分析奠定可信基礎
    - 與夥伴共同探討商業模式，以聲量觀測為切入點，將客戶需求逐步轉化為品牌大聲公的投遞場景，推動指定媒體推播作為解決方案
    - 執行 POC 驗證整合銷售 的實踐價值，確保品牌曝光策略能充分考量兩套產品的媒體涵蓋率與轉化效率
  - 公司產品上架開店平台（推動公司產品 SaaS 化）
    - 以開店平台為合作對象，鎖定電商客戶群，協助佈局站內 MarTech 工具上架至開店平台 APP 市集/擴充功能
    - 協助產品開通、初始設定自動化的前置準備
    - 規劃整合多開店平台的產品訂閱管理系統
...
## 產品管理師 — [久大寰宇資訊股份有限公司](https://www.isb.com.tw/)（2022.3～2024.2）
